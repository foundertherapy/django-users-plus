...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0004_auto_20150313_1652'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='company',
            name='street_address',
            field=models.CharField(max_length=200, verbose_name='Street Address', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='company',
            name='street_address_2',
            field=models.CharField(max_length=200, verbose_name='Street Address 2', blank=True),
            preserve_default=True,
        ),
    ]
