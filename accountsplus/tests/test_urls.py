...
class UrlsTestCase(django.test.SimpleTestCase):
    ...
    def test_login_urls(self):
        ...
        self.assertEqual(django.shortcuts.resolve_url('logout'), '/logout/')

    def test_password_change_urls(self):
        self.assertEqual(django.shortcuts.resolve_url('password_change'), '/password_change/')
        self.assertEqual(django.shortcuts.resolve_url('password_change_done'), '/password_change/done/')
    ...
    def test_masquerade_urls(self):
        ...
        self.assertEqual(django.shortcuts.resolve_url('masquerade', user_id=1), '/admin/masquerade/1/')
